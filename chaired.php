...
$participants = mysqli_query($conn, "SELECT * FROM `members` WHERE `particapation` ='chaired'");
...
<body>
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
      ...
      <!-- Bordered Table -->
      <div class="card">
        <h5 class="card-header">Certificate for Chaired participated</h5>
        <div class="card-body">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".get-certificate").click(function() {
        ...
        $.ajax({
          type: "POST",
          url: "certificate/chaired.php", // Replace with the URL of your PHP script
          data: {
            rollno: pid,
