...
$im = imagecreatefrompng("oralpresented.png");
...
$result=mysqli_query($conn, "SELECT * FROM `presented` WHERE `mobile`='$rollno'");
...
imagettftext($im, 30, 0, 345, 640, $black, $font, $sname);
